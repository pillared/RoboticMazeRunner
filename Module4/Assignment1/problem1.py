...
face_cascade = cv.CascadeClassifier('./Module4/Assignment1/haarcascade_frontalface_alt.xml')
eye_cascade = cv.CascadeClassifier('./Module4/Assignment1/haarcascade_eye.xml')
